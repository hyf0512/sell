	...
	<div>
		<div class="goods">
			...
			<div class="foods-wrapper" ref="foodswrapper">
				<ul>
					<li v-for="item in goods" :key="item.key" class="food-list food-list-hook">
						<h1 class="title">{{item.name}}</h1>
						<ul>
							<li v-for="food in item.foods" class="food-item border-1px" :key="food.key" @click="selectFood(food, $event)">
								<div class="icon">
